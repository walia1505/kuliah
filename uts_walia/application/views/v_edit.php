      ...
      <div class="row">
		...
		<form action="<?php echo base_url('c_mahasiswa/editdata'); ?>" method="POST">
			<div class="modal-body">
				<div>
					<input type="hidden" value="<?php echo $a['id']; ?>" name="id_mahasiswa"></input>
				</div>
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nama_mahasiswa" class="form-control" maxlength="20" type="text" placeholder="Nama mahasiswa" value="<?php echo $a['nama_mhs']; ?>" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nomer_hp" class="form-control" type="number" placeholder="Nomor HP" value="<?php echo $a['no_hp']; ?>" required>
                        </div>
                    </div>
